...
AEC members will evaluate artifacts submitted by authors to assess:

- Consistency and reproducibility of results;
- Completeness and documentation;
- Ease of use and availability.

Members are expected to review 2-4 artifacts per round following the EAPLS artifact badging guidelines.

## Timeline

For the detailed timeline, see: https://spin-web.github.io/SPIN2026/artifacts

### Mandatory AE Round (Full Tool Papers)

- 2026-01-29: Artifact submission
- 2026-03-05: Notification

### Voluntary AE Round (Other Categories)

- 2026-03-16: Artifact submission
- 2026-04-09: Notification
